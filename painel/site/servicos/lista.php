<?php
    ...
    if($_POST['delete']){
        if($_POST['imagem']){
            unlink("../volume/servicos/".$_POST['imagem']);
        }
        $query = "delete from servicos where codigo = '{$_POST['delete']}'";
        mysqli_query($con, $query);
      }

      if($_POST['situacao']){
        // mysqli_query($con, "update servicos set situacao = '0'");
...
<div class="col">
  <div class="m-3">
    ...
    <div class="row">
      <div class="col">
        <div class="card">
          <h5 class="card-header">Lista de Serviços</h5>
          <div class="card-body">
            ...
            <table class="table table-striped table-hover">
              ...
              <tbody>
                <?php
                  $query = "select * from servicos order by titulo asc";
