<?php
    ...
    if($_POST['delete']){
        if($_POST['imagem']){
            unlink("../volume/time/".$_POST['imagem']);
        }
        $query = "delete from time where codigo = '{$_POST['delete']}'";
        mysqli_query($con, $query);
      }

      if($_POST['situacao']){
        // mysqli_query($con, "update noticias set situacao = '0'");
        $query = "update time set situacao = '{$_POST['opc']}' where codigo = '{$_POST['situacao']}'";
        mysqli_query($con, $query);
        exit();
      }
...
<div class="col">
  <div class="m-3">
    ...
    <div class="row">
      <div class="col">
        <div class="card">
          <h5 class="card-header">Lista do Time da Empresa</h5>
          <div class="card-body">
            ...
            <table class="table table-striped table-hover">
              <thead>
                <tr>
                  ...
                  <th scope="col" style="width:50%">Cargo</th>
