<?php
    ...
    if($_POST['delete']){
        ...
        $query = "delete from depoimentos where codigo = '{$_POST['delete']}'";
        mysqli_query($con, $query);
      }

      if($_POST['situacao']){
        // mysqli_query($con, "update noticias set situacao = '0'");
        $query = "update depoimentos set situacao = '{$_POST['opc']}' where codigo = '{$_POST['situacao']}'";
        mysqli_query($con, $query);
        exit();
      }
            ...
            <table class="table table-striped table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="white-space: nowrap;"><?=$d->empresa?></td>
