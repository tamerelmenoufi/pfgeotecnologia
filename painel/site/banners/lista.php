<?php
    ...
    if($_POST['delete']){
        if($_POST['imagem']){
            unlink("../volume/banners/".$_POST['imagem']);
        }
        $query = "delete from banners where codigo = '{$_POST['delete']}'";
...
<div class="col">
  <div class="m-3">
    ...
    <div class="row">
      <div class="col">
        <div class="card">
          <h5 class="card-header">Lista de Banners</h5>
          <div class="card-body">
            ...
            <table class="table table-striped table-hover">
              ...
              <tbody>
                <?php
                  $query = "select * from banners order by titulo asc";
