<?php
    ...
    if($_POST['delete']){
        ...
        $query = "delete from portifolio where codigo = '{$_POST['delete']}'";
        mysqli_query($con, $query);
      }

      if($_POST['situacao']){
        // mysqli_query($con, "update noticias set situacao = '0'");
        $query = "update portifolio set situacao = '{$_POST['opc']}' where codigo = '{$_POST['situacao']}'";
        mysqli_query($con, $query);
        exit();
      }

      if($_POST['categoria']) $_SESSION['categoria_cod'] = $_POST['categoria'];
      if($_POST['nome']) $_SESSION['categoria_nome'] = $_POST['nome'];
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div style="display:flex; justify-content:end">
                <button
                    voltar
                    url="site/portifolio/index.php"
                    class="btn btn-warning"
                    style="margin-right:10px;"
                ><i class="fa-solid fa-chevron-left"></i> Voltar</button>
                <button
                    novoCadastro
            ...
            <table class="table table-striped table-hover">
              ...
              <tbody>
                <?php
                  $query = "select * from portifolio where categoria = '{$_SESSION['categoria_cod']}' order by titulo asc";
